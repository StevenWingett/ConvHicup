...
sub perc_str {
	...
	return 'NA' unless(defined $n and defined $total);    #Steven: Avoid initialisation error
	return 'NA' if($total == 0);    #Steven: Avoid division by zero error
